<!DOCTYPE html>
<html lang="id" style="overflow-x: hidden;"> <!-- Kunci 1: Lock di level HTML -->
...
<head>
    ...
    <style>
        ...
        /* Kunci 2: Pakai overflow-x: clip atau hidden di body & html */
        html, body {
            max-width: 100%;
            overflow-x: hidden;
            position: relative;
        ...
        .step-dot { position: absolute; left: -36px; top: 25px; width: 20px; height: 20px; background: #ffffff; border: 5px solid #e2e8f0; border-radius: 50%; z-index: 10; box-shadow: 0 0 0 5px #f0f4f8; transition: all 0.3s ease; }
        ...
        .gallery-item { aspect-ratio: 1/1; border-radius: 1.5rem; overflow: hidden; border: 4px solid white; box-shadow: 0 8px 16px rgba(0,0,0,0.1); background: #e2e8f0; transform: translateZ(0); will-change: transform, opacity; }
        .gallery-item img { width: 100%; height: 100%; object-fit: cover; transition: opacity 0.5s ease; }
...
<body>
    <!-- Kunci 3: Wrap seluruh konten dalam div overflow-hidden -->
    <div style="overflow-x: hidden; width: 100%;">
        ...
        <main id="main-app" class="hidden opacity-0">
            ...
            <section class="min-h-screen flex flex-col items-center justify-center px-6 text-center relative overflow-hidden">
                <div class="hero-static">
                    ...
                    <div class="grid grid-cols-4 gap-3 mb-20">
                        ...
                        <div class="card-elevated py-4 flex flex-col items-center justify-center bg-white shadow-lg">
            ...
            <!-- AGENDA (Kunci: Pakai data-aos="fade-up" jangan fade-left agar tidak scroll X) -->
            <section class="py-20 px-6">
                ...
                <div class="timeline-wrapper" id="timeline-box">
                    ...
                    <div class="agenda-item">
                        <div class="step-dot" data-aos="zoom-in"></div>
            ...
            <section class="py-20 px-6">
                ...
                <div class="gallery-grid">
                    @php $images = ['aa', 'kalinda', 'aji', 'arul', 'apit', 'fahri', 'farel', 'fb-1', 'gf', 'ipan', 'jojo', 'jon', 'nopal', 'rani', 'rapli', 'zahra', 'dwi', 'takjil']; @endphp
                ...
                <div class="card-elevated p-8 text-center border-t-8 border-t-[#0078b7]" data-aos="fade-up">
                    ...
                    <form action="{{ route('rsvp.store') }}" method="POST" class="text-left space-y-8">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" required class="w-full bg-slate-50 border-4 border-transparent focus:border-[#0078b7] p-5 rounded-2xl font-bold transition-all outline-none shadow-inner" placeholder="Masukkan nama kamu">
                        </div>
    ...
    <script>
        function explodeAndOpen() {
            ...
            gsap.to("#gate", { yPercent: -100, duration: 1.2, ease: "expo.inOut", onComplete: () => {
                ...
                // Init AOS dengan mematikan scroll horizontal secara paksa
                AOS.init({ 
                    duration: 800, 
                    once: true, 
                    offset: 50,
